...
func CreateHttpsServer(hostPort string, crt string, key string) {
	...
	fmt.Println("Welcome to Golang Haste Framework ########*****##### Copy-Right 2021, Open Source Project")
...
var upgrader = websocket.Upgrader{
	...
	HandshakeTimeout: time.Duration(Websocket["HandShakeDuration"]) * time.Minute,
    ReadBufferSize:  Websocket["ReadBufferSize"],
    WriteBufferSize: Websocket["WriteBufferSize"],
}
